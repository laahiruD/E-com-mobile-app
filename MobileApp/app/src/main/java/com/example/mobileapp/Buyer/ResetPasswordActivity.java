...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (check.equals("settings")) {
            ...
            titleQuestions.setText("Please set answer the following security questuons.");
    ...
    private void setAnswers(){
        ...
        private void verifyUser(){
            ...
            if(!phone.equals("") && !answer1.equals("") && !answer2.equals("")){
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.exists()){
                            ...
                            if(phone.equals(mPhone)){
                                ...
                                Toast.makeText(ResetPasswordActivity.this, "You have not set he security questions.", Toast.LENGTH_SHORT).show();
                            }
                        }else {
                ...
                Toast.makeText(this, "Please complete the actions", Toast.LENGTH_SHORT).show();
            }
